        ...
        <div class="container py-md-3">
            <div class="grid grid-column-2 py-md-5">
                ...
                <div class="column1">
                    ...
                    {!! Form::open(['url'=>'semCourseView','method'=>'GET','class'=>'form-horizontal'])!!}
                    <!--                    <div class="">                          
                                            <select id="sel1" class="form-control" name="deptId">
                                                <option>Select Department</option>
                                                @foreach($DepartmentCourse as $department)
                    ...
                    <div class="">
                        <select id="sel1" class="form-control" name="id">
                            ...
                            @foreach($publishedSemCourse as $semester)
...
<!--<a href="{{url('/semCourseView/'.$semester->id)}}">Submit</a>-->
                                <div class="column2">
                                    <div class="row">
                                        @foreach($publishedSemCourse as $semester)
                                        <a href="{{url('/course/view/'.$semester->id)}}" class="btn btn-success">
                                            <span class="glyphicon glyphicon-edit"> {{$semester->semTitle}}</span>
                                        </a>                                       
                                        @endforeach
                                    </div>
                                </div>
