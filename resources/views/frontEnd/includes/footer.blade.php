            ...
            <div class="d-grid grid-col-4 footer-top-29">
                ...
                <div class="footer-list-29 footer-4">
                    <ul>
                        ...
                        <li><a href="{{url('/deptCourseView')}}">Departmental Courses</a></li>
                        <li><a href="{{url('/deptCourseView2')}}">Search Semester Courses</a></li>
                        <li><a href="{{url('/course/view/')}}"> Semester Courses</a></li>
