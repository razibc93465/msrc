          ...
          <a class="navbar-brand" href="#index.html">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{url('/semCourse')}}">Sem Course</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{url('/deptCourseView2')}}">Services</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link" href="{{url('/searchResult')}}">Search Result</a>
                    </li>
                </ul>
